...
export default {
  ...
  apppointmentScheduledNotify(user: User, date: string, time: string, purpose: string): void {
    transporter.sendMail({
      from: MAIL_USERNAME,
      to: user.email,
  ...
  apppointmentCancelledNotify(user: User, date: string, time: string, purpose: string): void {
    transporter.sendMail({
      from: MAIL_USERNAME,
      to: user.email,
